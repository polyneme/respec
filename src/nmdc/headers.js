...
export const name = "nmdc/headers";

const status2text = {
  PD: "Pre-Draft",
  WGD: "NMDC Working Group Draft",
  WGA: "NMDC Working Group Approved Draft",
  FD: "NMDC Final Deliverable",
};
...
export function run(conf) {
  ...
  conf.thisVersion = `https://microbiomedata.github.io/${conf.shortName}/`;
  conf.issueTracker = `https://github.com/microbiomedata/${conf.shortName}/issues/`;
